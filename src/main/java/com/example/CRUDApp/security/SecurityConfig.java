...
//                .requestMatchers("/CRUDApp/**").permitAll()
                .requestMatchers("/CRUDApp/get/**").hasAuthority("USER")
                ...
                .requestMatchers("/CRUDApp/auth/delete/**").hasAuthority("ADMIN")
                .requestMatchers("/Flashcards/postCard/**").hasAuthority("ADMIN")
//                .requestMatchers("/Flashcards/getCard/**").hasAuthority("USER")
                .requestMatchers("/Flashcards/getCard/**").permitAll()
